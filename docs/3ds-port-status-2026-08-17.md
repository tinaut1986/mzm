...
**Nuevo síntoma que aparece al quedar el resto limpio: la MÚSICA no se oye** (los efectos de sonido sí). Bug distinto y todavía sin diagnosticar — ver sección 6t.
