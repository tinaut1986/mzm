...
**Seguimiento y resolución:** Este problema fue investigado y resuelto definitivamente en la **sección 6m** (causa: escritura fuera de límites en `SpriteDebrisInit` que corrompía `gCurrentSprite`).
