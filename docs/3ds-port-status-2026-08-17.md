...
- **Audio: petardeo residual + regresión de FPS a ~20 (rama `wip/3ds-port-audio`, 2026-08-19).** Ver sección 6k para el detalle completo y las hipótesis a revisar. Seis bugs reales de audio ya arreglados y confirmados en hardware/Azahar (silencio→sonido real), pero el sonido sigue con petardeo sin limpiar del todo, y el movimiento del hilo de audio a Core 1 (pensado para arreglar una ralentización anterior) coincide con una caída a ~20 FPS de media sin diagnosticar todavía.
